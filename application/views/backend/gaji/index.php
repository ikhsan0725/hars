	...
	<div class="col-md-12">
		<div class="card box-shadow-2">
			...
			<div class="card-header">
				<h1 style="text-align: center">Gaji pasien</h1>
			</div>
			<div class="card-body">
				<table class="table table-bordered zero-configuration" style="width: 100%">
					...
					foreach ($gaji as $key => $value):
						...
						<tr>
							...
							<td><?= date_indo($value['pasien_tanggal_pemeriksaan']) ?></td>
							<td><?= $value['pasien_nomor_hp'] ?></td>
							<td>
								<a href="<?=base_url('gaji/detail/'.$value['pasien_id'])?>"
