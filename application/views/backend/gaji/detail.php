	...
	<div class="col-md-12">
		<div class="card box-shadow-2">
			...
			<div class="card-header">
				...
				?>
				<h1 style="text-align: center">Detail Gaji <?=$gaji[0]['pasien_nama']?></h1>
			</div>
			<div class="card-body">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<fieldset class="form-group floating-label-form-group">
					<label for="gaji_lihat_nama">Nama pasien</label>
					<input type="text" class="form-control" name="nama" id="gaji_lihat_nama" placeholder="Nama pasien"
				...
				<fieldset class="form-group floating-label-form-group">
					...
					<div class='input-group'>
						<input type="date" class="form-control" id="gaji_lihat_tg" name="tanggal_pemeriksaan"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header d-print-none">
				<h3 class="modal-title" id="myModalLabel35"> Lihat Biaya Pemeriksaan</h3>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body ">
				<div class="kotak d-print-block">
					<div class="row">
						<div class="col-12">
							<div class="tengah"><h3><b>Hammilton Anxiety Rating Scale</b></h3></div>
							<div class="tengah">Jalan Uka, Perumahan Garuda Permai, Kota Pekanbaru, Riau</div>
							<hr>
							<div class="tengah"><b><u>Faktur Pemeriksaan</u></b></div>
							<br>
						</div>
					</div>
					<div class="row">
...
<div class="modal fade text-left" id="bayar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title" id="myModalLabel35"> pasien sudah menerima gaji ?</h3>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
