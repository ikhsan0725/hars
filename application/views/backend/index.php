								...
								<div class="card-body">
									<div class="media d-flex">
										...
										<div class="media-body text-right mt-1">
											<h3 class="font-large-2 white"><?= $jumlah_pasien ?></h3>
											<h6 class="mt-1"><span class="text-muted white">Jumlah Semua Pasien</h6>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="card-body">
									<div class="media d-flex">
										...
										<div class="media-body text-right mt-1">
											...
											<h6 class="mt-1"><span class="text-muted white">Jumlah pasien Absen Hari Ini
											</h6>
										</div>
									</div>
								</div>
			...
			<div class="col-lg-4 col-md-12">
				<div class="row">
					<div class="col-12">
						<div class="card pull-up bg-gradient-directional-danger">
							<div class="card-header bg-hexagons-danger">
								<h4 class="card-title white">Tes Pasien</h4>
								<a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
								<div class="heading-elements">
									<ul class="list-inline mb-0">
										<li>
								...
								<div class="card-body">
									<div class="media d-flex">
										...
										<div class="media-body text-right mt-1">
											...
											<h6 class="mt-1"><span class="text-muted white">Jumlah yang Mengikuti Tes
											</h6>
										</div>
									</div>
								</div>
