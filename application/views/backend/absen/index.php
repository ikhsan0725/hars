		...
		<div class="card box-shadow-2">
			...
			elseif ($this->session->flashdata('alert') == 'absen_sudah_ada'):
				...
				<div class="alert alert-danger alert-dismissible animated fadeInDown" id="feedback" role="alert">
					...
					pasien sudah absen hari ini
				</div>
			<?php
			endif;
			?>
			<div class="card-header">
				<h1 style="text-align: center">Absen pasien</h1>
								...
								<?php if ($this->session->userdata('session_hak_akses') == 'admin'): ?>
									...
									if ($value['absen_status'] == 'normal'):
										...
										<button
											...
											title="<?= $value['pasien_nama'] ?> lembur? "><i class="ft-moon"></i>
										</button>
									<?php
									elseif ($value['absen_status'] == 'lembur'):
										?>
										<button
											class="btn btn-success btn-sm  btn-bg-gradient-x-purple-blue box-shadow-2 absen-lembur"
											data-toggle="modal" data-target="#lembur" value="<?= $value['absen_id'] ?>"
											title="<?= $value['pasien_nama'] ?> lembur " disabled><i
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-group floating-label-form-group">
					...
					<input type="hidden" id="id_pasien" name="nama">
				</div>
				<div class="form-group floating-label-form-group">
...
<div class="modal fade text-left" id="lembur" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title" id="myModalLabel35"> pasien Lembur ?</h3>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
