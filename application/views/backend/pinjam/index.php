	...
	<div class="col-md-12">
		<div class="card box-shadow-2">
			...
			<div class="card-header">
				<h1 style="text-align: center">Pinjaman pasien</h1>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-group floating-label-form-group">
					...
					<input type="text" name="nama_autocomplete" id="nama_pasien" class="form-control" placeholder="Nama pasien" required>
