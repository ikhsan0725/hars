					...
					<fieldset class="form-group floating-label-form-group">
						...
						<div class="row">
							...
							<div class="col-4 mt-2">
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">1. Tinitus</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">2. Penglihatan Kabur</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">3. Muka Merah atau Pucat</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">4. Merasa Lemas</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">5. Perasaan Ditusuk-tusuk</label>
							</div>
							<!-- <div class="col-3"></div> -->
							...
							<?= form_open('q8/update') ?>
								...
								<fieldset class="form-group floating-label-form-group">								
									...
									<input type="number" class="form-control" id="item_delapan" name="item_delapan" placeholder="Masukkan Jumlah Gejala yang Anda Rasakan" autocomplete="off" required>
