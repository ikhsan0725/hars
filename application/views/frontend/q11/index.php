					...
					<fieldset class="form-group floating-label-form-group">
						...
						<div class="row">
							...
							<div class="col-4 mt-2">
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">1. Sulit Menelan</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">2. Perut Melilit</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">3. Gangguan Pencernaan</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">4. Nyeri Sebelum dan Sesudah Makan</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">5. Perasaan Terbakar di Perut</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">6. Kembung</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">7. Mual</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">8. Muntah</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">9. Buang Air Besar Lembek</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">10. Berat Badan Turun</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">11. Susah Buang Air Besar</label>
							</div>
							<!-- <div class="col-3"></div> -->
							<div class="col-4 mt-4">								
							<?= form_open('q11/update') ?>
								<fieldset class="form-group floating-label-form-group">
								...
								<fieldset class="form-group floating-label-form-group">								
										...
										<input type="hidden" id="item_sembilan" name="item_sembilan" value="<?= $nilai['nilai_item_sembilan'] ?>">
										<input type="hidden" id="item_sepuluh" name="item_sepuluh" value="<?= $nilai['nilai_item_sepuluh'] ?>">
									<input type="number" class="form-control" id="item_sebelas" name="item_sebelas" placeholder="Masukkan Jumlah Gejala yang Anda Rasakan" autocomplete="off" required>
