					...
					<fieldset class="form-group floating-label-form-group">
						...
						<div class="row">
							...
							<div class="col-4 mt-2">
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">1. Sakit dan Nyeri Otot</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">2. Kaku</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">3. Kedutan otot</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">4. Gigi Gemerutuk</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">5. Suara Tidak Stabil</label>
							</div>
							<!-- <div class="col-3"></div> -->
							...
							<?= form_open('q7/update') ?>
								...
								<fieldset class="form-group floating-label-form-group">								
									...
									<input type="number" class="form-control" id="item_tujuh" name="item_tujuh" placeholder="Masukkan Jumlah Gejala yang Anda Rasakan" autocomplete="off" required>
