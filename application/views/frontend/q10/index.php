					...
					<fieldset class="form-group floating-label-form-group">
						...
						<div class="row">
							...
							<div class="col-4 mt-2">
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">1. Rasa Tertekan di Dada</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">2. Perasaan Tercekik</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">3. Sering Menarik Napas</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">4. Napas Pendek atau Sesak</label>
							</div>
							<!-- <div class="col-3"></div> -->
							<div class="col-4 mt-4">								
							<?= form_open('q10/update') ?>
								<fieldset class="form-group floating-label-form-group">
								...
								<fieldset class="form-group floating-label-form-group">								
									...
									<input type="number" class="form-control" id="item_sepuluh" name="item_sepuluh" placeholder="Masukkan Jumlah Gejala yang Anda Rasakan" autocomplete="off" required>
