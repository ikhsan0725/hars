					...
					<fieldset class="form-group floating-label-form-group">
						...
						<div class="row">
							...
							<div class="col-4 mt-2">
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">1. Sering Kencing</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">2. Tidak Dapat Menahan Air Seni</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: italic;">3. Amenorrhoe</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: italic;">4. Menorrhagia</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: italic;">5. Frigid</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: italic;">6. Ejakulasi Praecocks</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">7. Ereksi Lemah</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">8. Impotensi</label>
							</div>
							<!-- <div class="col-3"></div> -->
							<div class="col-4 mt-4">								
							<?= form_open('q12/update') ?>
								<fieldset class="form-group floating-label-form-group">
								...
								<fieldset class="form-group floating-label-form-group">								
									...
									<input type="number" class="form-control" id="item_duabelas" name="item_duabelas" placeholder="Masukkan Jumlah Gejala yang Anda Rasakan" autocomplete="off" required>
