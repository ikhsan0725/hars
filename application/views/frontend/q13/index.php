					...
					<fieldset class="form-group floating-label-form-group">
						...
						<div class="row">
							...
							<div class="col-4 mt-2">
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">1. Mulut Kering</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">2. Muka Merah</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">3. Mudah Berkeringat</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">4. Pusing</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">5. Bulu Roma Berdiri</label>
							</div>
							<!-- <div class="col-3"></div> -->
							<div class="col-4 mt-4">								
							<?= form_open('q13/update') ?>
								<fieldset class="form-group floating-label-form-group">
								...
								<fieldset class="form-group floating-label-form-group">								
									...
									<input type="number" class="form-control" id="item_tigabelas" name="item_tigabelas" placeholder="Masukkan Jumlah Gejala yang Anda Rasakan" autocomplete="off" required>
