					...
					<fieldset class="form-group floating-label-form-group">
						...
						<div class="row">
							...
							<div class="col-4 mt-2">
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">1. Sukar Memulai Tidur</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">2. Sering Terbangun pada Malam Hari</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">3. Tidur Tidak Pulas</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">4. Bangun dengan Lesu</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">5. Banyak Mimpi-Mimpi</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">6. Mimpi Buruk</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">7. Mimpi Menakutkan</label>
							</div>
							<!-- <div class="col-3"></div> -->
							...
							<?= form_open('q4/update') ?>
								...
								<fieldset class="form-group floating-label-form-group">								
									...
									<input type="number" class="form-control" id="item_empat" name="item_empat" placeholder="Masukkan Jumlah Gejala yang Anda Rasakan" autocomplete="off" required>
