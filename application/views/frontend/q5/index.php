					...
					<fieldset class="form-group floating-label-form-group">
						...
						<div class="row">
							...
							<div class="col-4 mt-2">
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">1. Daya Ingat Buruk</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">2. Susah Berkonsentrasi</label>								
							</div>
							<!-- <div class="col-3"></div> -->
							...
							<?= form_open('q5/update') ?>
								...
								<fieldset class="form-group floating-label-form-group">								
									...
									<input type="number" class="form-control" id="item_lima" name="item_lima" placeholder="Masukkan Jumlah Gejala yang Anda Rasakan" autocomplete="off" required>
