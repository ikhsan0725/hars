					...
					<fieldset class="form-group floating-label-form-group">
						...
						<div class="row">
							...
							<div class="col-4 mt-2">
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">1. Takut Terhadap Gelap</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">2. Takut Terhadap Orang Asing</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">3. Takut Bila Ditinggal Sendiri</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">4. Takut pada Binatang Besar</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">5. Takut pada Keramain Lalu Lintas</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">6. Takut pada Kerumunan Orang Banyak</label>
							</div>
							<!-- <div class="col-3"></div> -->
							...
							<?= form_open('q3/update') ?>
								...
								<fieldset class="form-group floating-label-form-group">								
									...
									<input type="number" class="form-control" id="item_tiga" name="item_tiga" placeholder="Masukkan Jumlah Gejala yang Anda Rasakan" autocomplete="off" required>
