					...
					<fieldset class="form-group floating-label-form-group">
						...
						<div class="row">
							...
							<div class="col-4 mt-2">
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">1. Hilangnya Minat</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">2. Berkurangnya Kesenangan pada Hobi</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">3. Sedih</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">4. Bangun Dini Hari</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">5. Perasaan Berubah-ubah Sepanjang Hari</label>
							</div>
							<!-- <div class="col-3"></div> -->
							...
							<?= form_open('q6/update') ?>
								...
								<fieldset class="form-group floating-label-form-group">								
									...
									<input type="number" class="form-control" id="item_enam" name="item_enam" placeholder="Masukkan Jumlah Gejala yang Anda Rasakan" autocomplete="off" required>
