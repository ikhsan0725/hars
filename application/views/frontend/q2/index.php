					...
					<fieldset class="form-group floating-label-form-group">
						...
						<div class="row">
							...
							<div class="col-4 mt-2">
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">1. Merasa Tegang</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">2. Gelisah</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">3. Gemetar</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">4. Mudah menangis dan Lesu</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">5. Tidak Bisa Istirahat</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">6. Mudah Terkejut</label>
							</div>
							<!-- <div class="col-3"></div> -->
							...
							<?= form_open('q2/update') ?>
								...
								<fieldset class="form-group floating-label-form-group">		
									...
									<input type="number" class="form-control" id="item_dua" name="item_dua" placeholder="Masukkan Jumlah Gejala yang Anda Rasakan" autocomplete="off" required>
