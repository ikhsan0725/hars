					...
					<fieldset class="form-group floating-label-form-group">
						...
						<div class="row">
							...
							<div class="col-4 mt-2">
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">1. Gelisah</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">2. Tidak Tenang</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">3. Jari Gemetar</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">4. Kerut Kening</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">5. Muka Tegang</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">6. Tonus Otot Meningkat</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">7. Napas Pendek dan Cepat</label>
								<br>
								<label for="laporan-tahun" style="font-size: 16px; font-weight: bold;">8. Muka Merah</label>
							</div>
							<!-- <div class="col-3"></div> -->
							<div class="col-4 mt-4">								
							<?= form_open('q14/update') ?>
								<fieldset class="form-group floating-label-form-group">
								...
								<fieldset class="form-group floating-label-form-group">								
										...
										<input type="hidden" id="item_sebelas" name="item_sebelas" value="<?= $nilai['nilai_item_sebelas'] ?>">
										<input type="hidden" id="item_duabelas" name="item_duabelas" value="<?= $nilai['nilai_item_duabelas'] ?>">
										<input type="hidden" id="item_tigabelas" name="item_tigabelas" value="<?= $nilai['nilai_item_tigabelas'] ?>">
									<input type="number" class="form-control" id="item_empatbelas" name="item_empatbelas" placeholder="Masukkan Jumlah Gejala yang Anda Rasakan" autocomplete="off" required>
								</fieldset>
							</div>
						</div>
						<div class="row">
