...
<footer class="footer footer-static footer-light navbar-border navbar-shadow d-print-none">
	<div class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2"><span class="float-md-left d-block d-md-inline-block"><?= date('Y') ?> &copy; Copyright | <a class="text-bold-800 grey darken-2" href="http://wikidevia.digtive.id/" target="_blank">...</a>
...
<script src="<?= base_url() ?>assets/js/core/hars.js" type="text/javascript"></script>
<!-- END: Page JS-->
