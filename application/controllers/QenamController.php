...
class QenamController extends CI_Controller{
  public function __construct()
  {
    parent::__construct();
    $model = array('QenamModel','PasienModel');
  ...
  public function index()
  {
      ...
      $data['data'] = $this->QenamModel->lihat_satu_pasien($id);
      $data['nilai'] = $this->QenamModel->lihat_satu_nilai($ciri);
      $data['title'] = '6. Perasaan Depresi';
    
    $this->load->view('templates/header_tes',$data);
    $this->load->view('frontend/q6/index',$data);
  ...
  public function update()
  {
    if (isset($_POST['update'])){
      ...
      $data = array(
        ...
        'nilai_total' => $item_satu + $item_dua + $item_tiga + $item_empat + $item_lima + $item_enam
      );
      $save = $this->QenamModel->update_qenam($id,$data);
      if ($save>0){
